# Claude Code Task — SDSS Night-Sky Residual Quality Audit
...
5. Implement reusable scientific modules under `src/sdss_sky_residual_quality_audit/`; notebooks must only orchestrate imported functions.
